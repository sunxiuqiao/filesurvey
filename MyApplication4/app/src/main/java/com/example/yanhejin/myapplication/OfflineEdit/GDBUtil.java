...
public class GDBUtil {
  ...
  * */
   ...
   * Go back online
   */
  public static void goOnline(final MainActivity activity, final MapView mapView) {
  ...
  *
  * */
  private static void finishGoingOnline(final MainActivity activity, final MapView mapView){
   ...
   * @param activity
   */
  public static void downloadData(final MainActivity activity) {
  ...
  private static void downloadGeodatabase(final MainActivity activity, final MapView mapView) {
    ...
    if (!isGeoDatabaseLocal()) {//if this file is existed
  ...
  private static void requestGdbFromServer(GeodatabaseSyncTask geodatabaseSyncTask,
      final MainActivity activity, final MapView mapView, FeatureServiceInfo fsInfo) {
  ...
  private static void addLocalLayers(final MapView mapView, String gdbPath, final MainActivity activity) {
  ...
  static void synchronize(final MainActivity activity) {
    showProgress(activity, true);
   ...
   * @throws Exception
   */
  private static void doSyncAllInOne(final MainActivity activity) {
  ...
  public static void showProgress(final MainActivity activity, final boolean b) {
  ...
  public static void showMessage(final MainActivity activity, final String message) {
    activity.runOnUiThread(new Runnable() {
